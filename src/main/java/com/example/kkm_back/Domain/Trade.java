...
public class Trade {
    ...
    public Trade(long trade_id, long post_id, long post_owner_id, long trader_id, long trade_type, long trade_cost, long trade_state,java.sql.Timestamp start_time, java.sql.Timestamp expired_time,long post_state){
